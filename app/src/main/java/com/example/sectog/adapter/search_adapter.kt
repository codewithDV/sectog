...
import com.example.sectog.databinding.SearchdesignBinding
...
//    )
    ...
    inner class ViewHolder(val binding: SearchdesignBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = SearchdesignBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.ivCloth.setImageResource(Imageprofile[position])
        holder.binding.tvWname.text = NameCloth[position]
        holder.binding.tvWbrandName.text = textBrand[position]
        holder.binding.tvWrate.text = "$" + clothPriceOne[position].toString()
        holder.binding.priceTv.text = "$" + clothPriceTwo[position].toString()
